...
public final class MainActivity extends androidx.appcompat.app.AppCompatActivity {
    ...
    private final void bindPreviewImageViewClickListener() {
    }
    
    private final void initFlashAndAddListener() {
    }
    
    @android.annotation.SuppressLint(value = {"ClickableViewAccessibility"})
    private final void bindZoomListener() {
    }
    ...
    private final void flashLight(boolean light) {
    }

...
import hgh.project.subway_map.databinding.ItemArrivalsBinding
...
class StationArrivalsAdapter : RecyclerView.Adapter<StationArrivalsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(ItemArrivalsBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    ...
    inner class ViewHolder(private val viewBinding: ItemArrivalsBinding) : RecyclerView.ViewHolder(viewBinding.root) {
